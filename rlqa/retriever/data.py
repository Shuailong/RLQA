...
class RetriverDataset(Dataset):
    ...
    def lengths(self):
        return [(len(ex['question']),) for ex in self.examples]


# ------------------------------------------------------------------------------
# PyTorch sampler returning batched of sorted lengths (by question).
# ------------------------------------------------------------------------------
...
class SortedBatchSampler(Sampler):
    ...
    def __iter__(self):
        lengths = np.array(
            [(-l[0], np.random.random()) for l in self.lengths],
